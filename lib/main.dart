...
import 'screens/priest/help_request_screen.dart';
...
import 'screens/diocese_admin/diocese_home.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/priest/notifications': (context) => const SendNotificationScreen(),
          '/priest/help': (context) => const HelpRequestScreen(),
          ...
          '/diocese/home': (context) => const DioceseHome(),
          // Super Admin routes
