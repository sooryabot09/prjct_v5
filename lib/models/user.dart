class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
      ...
      ordinationDate: json['ordination_date'] != null ? DateTime.parse(json['ordination_date']) : null,
      feastDate: json['feast_date'] != null ? DateTime.parse(json['feast_date']) : null,
      motto: json['motto'],
...
class Church {
  ...
  factory Church.fromJson(Map<String, dynamic> json) {
    return Church(
      churchId: json['church_id'] is int ? json['church_id'] : int.parse(json['church_id'].toString()),
      name: json['name'] ?? '',
  ...
  factory Service.fromJson(Map<String, dynamic> json) {
    return Service(
      ...
      splits: json['splits'] != null
          ? (json['splits'] as List).map((s) => SplitConfig.fromJson(s)).toList()
          : null,
    );
  }
...
class SplitConfig {
  ...
  factory SplitConfig.fromJson(Map<String, dynamic> json) {
    return SplitConfig(
      ...
      percentage: json['percentage'] is int ? json['percentage'] : int.parse(json['percentage'].toString()),
    );
  }
...
class Complaint {
  ...
  factory Complaint.fromJson(Map<String, dynamic> json) {
    return Complaint(
      complaintId: json['complaint_id'] is int ? json['complaint_id'] : int.parse(json['complaint_id'].toString()),
...
class Transaction {
  ...
  factory Transaction.fromJson(Map<String, dynamic> json) {
    return Transaction(
      transactionId: json['transaction_id'] is int ? json['transaction_id'] : int.parse(json['transaction_id'].toString()),
...
class Diocese {
  ...
  factory Diocese.fromJson(Map<String, dynamic> json) {
    return Diocese(
      dioceseId: json['diocese_id'] is int ? json['diocese_id'] : int.parse(json['diocese_id'].toString()),
      name: json['name'] ?? '',
      code: json['code'],
    );
  }
...
class Forane {
  ...
  factory Forane.fromJson(Map<String, dynamic> json) {
    return Forane(
      foraneId: json['forane_id'] is int ? json['forane_id'] : int.parse(json['forane_id'].toString()),
      dioceseId: json['diocese_id'] is int ? json['diocese_id'] : int.parse(json['diocese_id'].toString()),
      name: json['name'] ?? '',
      dioceseName: json['diocese_name'],
    );
